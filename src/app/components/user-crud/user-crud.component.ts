...
export class UserCrudComponent {
  ...
  viewUser(e:any){
   this.email=e.email;
   this.firstname=e.name.firstname;
   this.lastname=e.name.lastname;
   this.phone=e.phone;
  }

  addUser(fname:string, lname:string, email:string, phone:string){
    let newEmp={"address":{"geolocation":{"lat":"-37.3159","long":"81.1496"},"city":"kilcoole","street":"new road","number":7682,"zipcode":"12926-3874"},"id":1,"email":"john@gmail.com","username":"johnd","password":"m38rmF$","name":{"firstname":"john","lastname":"doe"},"phone":"1-570-236-7033","__v":0};
    newEmp.name.firstname=fname;
    newEmp.name.lastname=lname;
    newEmp.email=email;
    newEmp.phone=phone;
    this.userList.push(newEmp);
  }
  ...
  deleteUser(emp:any){
    Swal.fire({
      ...
      if (result.isConfirmed) {
        this.userList=this.userList.filter(e=>e.email!=emp.email);
        Swal.fire({
          title: "Deleted!",
