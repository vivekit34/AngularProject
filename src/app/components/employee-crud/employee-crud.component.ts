...
export class EmployeeCRUDComponent {
  ...
  addEmployee(fname:string, lname:string, email:string, phone:string){
  ...
  deleteEmployee(emp:any){
    Swal.fire({
      ...
      if (result.isConfirmed) {
        this.employees=this.employees.filter(e=>e.email!=emp.email);
        Swal.fire({
          title: "Deleted!",
